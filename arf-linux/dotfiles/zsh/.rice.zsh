...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=149
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=149
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=80
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=141
  ...
  # Context format when running with privileges: bold hostname@user.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%m@%n'
  # Context format when in SSH without privileges: hostname@user.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%m@%n'
  # Default context format (no privileges, no SSH): hostname@user.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%m@%n'

  # Show context always.
  # To hide it unless running with privileges or in SSH, remove the next line.
